...
\title{Capítulo -1: Origens, e sobre perguntas e respostas}
\author{Violeta Mar}
\date{}
...
\section*{Entre Cerrado e Mata Atlântica}
falar de mim, e minha trajetória no doutorado, e começar a falar da minha filosofia de matemática, que vai ser a base pras próximas três seções onde briso sobre as três áreas que o livro gira ao redor

\section*{Lógica: a maquinaria da análise mental}

\section*{Álgebra: sombras dos números, ou a estrutura das composições}

\section*{Combinatória: a selvageria da contagem, e o fractal de listas de listas}

\section*{As nossas perguntas e respostas}
Colocar teases sobre os teoremas e objetos mais legais do livro

\section*{Sobre este livro}
Se a forma que a autora (eu) te descreve estes mundos apela pra você, se quer saber como responder as perguntas que trouxemos, se quer fazer amizade com os objetos esotéricos que venho falando sobre - então leia esse livro! 

Falar aqui da dependência dos capítulos, de pré-requisitos, resumir os capítulos, enfatizar os resultados novos e onde eles estão.
