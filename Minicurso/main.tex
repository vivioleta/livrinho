...
\begin{exemplo*}[Análise Não-Standard]
  Tome um ultrafiltro não principal $u$ qualquer nos naturais e defina a estrutura $\mathbb{R}^*$ como sendo o ultraproduto de enumeráveis cópias de $\mathbb{R}$. Teorema da transferência, elementos infinitos e infinitesimais. Acho que $\mathbb{N}^*$ é modelo pra PA não standard.
\end{exemplo*}
