...
\begin{proposicao*}[A menos de isomorfismo perfis sempre são principais]
  Dado um $S \subset \mathcal{P}(V)$, existe um $S' \subset \mathcal{P}(V')$ tal que $S \cong S'$ e em $S'$ todo perfil é principal. O isomorfismo preserva interseções e uniões. Podemos tomar este $S'$ e este $V'$ de forma que todo perfil é principal para um único $v \in V'$. 
\end{proposicao*}
\begin{prova}
