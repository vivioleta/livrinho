...
\begin{definicao*}[As hipóteses da dualidade]
  ...
  Um conjunto de estrelas $\mathcal{F}$ é dito consistente se sempre que $\{A\} \in \mathcal{F}$ então nenhum $B \subset A$ é tal que $\{\lnot B\} \in \mathcal{F}$.
  ...
  \begin{align*} 
X &\mapsto  X \cap R \text{ se } X \subset \lnot A \\ 
X &\mapsto \lnot(X \cap R) \text{ se } \lnot X \subset \lnot A \\
...
\end{align*}
  ...
  Dizemos que um conjunto de estrelas $\mathcal{F}$ satisfaz a hipótese da dualidade se para quaisquer dois $A,B \in S$ com interseção vazia, existe um $R \in S$ tal que $R \subset \lnot A$, $\lnot R \subset \lnot B$, e a imagem de qualquer estrela em $\mathcal{F}$ via $(R,A)$-relativização ou $(R,B)$-relativização é ainda uma estrela em $\mathcal{F}$.
\end{definicao*}


\begin{teorema*}[Dualidade Árvore-Emaranhados]
  Seja $S \subset \mathcal{P}(V)$ fechado para complementar, finito, e satisfazendo a hipótese da dualidade. Seja $\mathcal{F}$ um conjunto de estrelas de $S$ satisfazendo a hipótese da dualidade.
...
\end{itemize}
  ...
  \begin{prova}
    ...
    Agora seguimos para demonstrar que pelo menos uma dessas opções acontece.
